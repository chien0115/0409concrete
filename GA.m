...
crossoverRate = 0.95; % 定義交配率
mutationRate = 0.25; % 突變率
...
figure
title('GA Blue-Average      Red-Minimum');
xlabel('Generation')
...
for i = 1:tg
    ...
    [A, S, best_dispatch_times] = selection(P, E, s, dispatch_times);
